...
Public Class regkeyvalue_ModificationMessage
    ' This class allows the user to be notified about whether or not
    ' their modifications were successful.

    Friend Shared Sub name()
